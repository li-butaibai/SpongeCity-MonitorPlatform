...
<div id="services" class="services">
    <div class="container">
        <h3 class="title"><strong>同德佳苑—液位计</strong></h3>
        <div class="about-text">
            <%--<c:forEach items="${device.dataList}" var="dt">--%>
                <div class="col-md-6">
                    <div class="data-top"><h3 style="margin-top: 3px"><strong>东侧雨水花园</strong></h3></div>
                        <div  class="services-left1" style="display: table">
                            <div style="display: table-cell; vertical-align: middle; padding-left: 10px; padding-right: 10px;">
                                <strong style="font-size: 79px; line-height: 79px;">液位高度</strong>
                            </div>
                        </div>
                ...
                <%--<div class="col-md-6">--%>
                    <%--<div  class="data-top"><h3 style="margin-top: 3px"><strong>东侧雨水花园出水口</strong></h3></div>--%>
                        <%--<div  class="services-left1" style="display: table">--%>
                            <%--<div style="display: table-cell; vertical-align: middle; padding-left: 10px; padding-right: 10px;">--%>
                                <%--<strong style="font-size: 48px; line-height: 46px;">液位高度</strong>--%>
                            <%--</div>--%>
                        <%--</div>--%>
                    <%--<div  class="services-right">--%>
                        <%--<h4>142mm</h4>--%>
                ...
                <%--</div>--%>
                <div class="col-md-6">
                    <div  class="data-top"><h3 style="margin-top: 3px"><strong>西侧雨水花园</strong></h3></div>
                        <div  class="services-left1" style="display: table">
                            <div style="display: table-cell; vertical-align: middle; padding-left: 10px; padding-right: 10px;">
                                <strong style="font-size: 79px; line-height: 79px;">液位高度</strong>
                            </div>
