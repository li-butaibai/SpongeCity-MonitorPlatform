        ...
        <div class="col-md-6 services-grids">
          <div  class="services-left1" style="display: table">
            <div style="display: table-cell; vertical-align: middle; padding-left: 10px; padding-right: 10px;">
              <%--<span class="glyphicon glyphicon-time"><p style="font-size:24px">--%>
                <strong style="font-size: 79px; line-height: 79px;">${dt.dataTypeName}</strong>
              <%--</p></span>--%>
            </div>
          </div>
        <div  class="services-right">
          <c:choose>
            <c:when test="${dt.dataTypeName=='雨量'}">
              <h4>0.00mm</h4>
            </c:when>
            <c:otherwise>
